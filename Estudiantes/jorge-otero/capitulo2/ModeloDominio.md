...
| Diagrama | Código Fuente |
|----------|---------------|
|![Diagrama de Estado](./MdD/DdE/imagen/Cliente.png)|[Ver Código del Diagrama de Estado del Cliente](./MdD/DdE/codigo/Cliente.puml)
...
| Diagrama | Código Fuente |
|----------|---------------|
|![Diagrama de Estado](./MdD/DdE/imagen/Tecnico.png)|[Ver Código del Diagrama de Estado del Tecnico](./MdD/DdE/codigo/Tecnico.puml)
